...
\FloatBarrier
\textbf{\\Dibujar un esquema o diagrama que identifique el dataset visualmente y el proyecto elegido.} \\
\FloatBarrier
...
\newpage 
\section{Contenido}
\textbf{Explicar los campos que incluye el dataset, el periodo de tiempo de los datos y cómo se han recogido.} \\
